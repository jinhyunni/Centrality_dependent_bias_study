void plotMake_dNdeta_inTargetEvents_hardPion0Dir()
{
	TFile *input1 = new TFile("pAu200GeV_option3_dirAdded_decayOn_dNdeta_inTargetEvents_hardPion0Dir.root", "read");
    TFile *input2 = new TFile("pAu200GeV_option3_dirAdded_decayOn_dNdeta_MBevents.root", "read");
    
    //dndeta by centrality
    //--------------------
    TH1D *pion0_inpion0 = (TH1D*)input1 -> Get("dndeta_pion0_hpion0");
    TH1D *pion0_indir = (TH1D*)input1 -> Get("dndeta_pion0_hdir");
    
    TH1D *pionCh_inpion0 = (TH1D*)input1 -> Get("dndeta_pionCh_hpion0");
    TH1D *kaonCh_inpion0 = (TH1D*)input1 -> Get("dndeta_kaonCh_hpion0");
    TH1D *protonCh_inpion0 = (TH1D*)input1 -> Get("dndeta_protonCh_hpion0");
    
    TH1D *pionCh_indir = (TH1D*)input1 -> Get("dndeta_pionCh_hdir");
    TH1D *kaonCh_indir = (TH1D*)input1 -> Get("dndeta_kaonCh_hdir");
    TH1D *protonCh_indir = (TH1D*)input1 -> Get("dndeta_protonCh_hdir");
	...
	TCanvas *c1 = new TCanvas("", "", 800, 600);
	{
        ...
        leg1 -> AddEntry("", "high p_{T}: more than 2 GeV", "h");
        leg1 -> AddEntry(dndeta_charge_inpion0, "charged particles in event including high-p_{T} #pi^{0} in |#eta|<1", "p");
        leg1 -> AddEntry(dndeta_charge_indir, "charged particles in event including high-p_{T}#gamma^{dir} in |#eta|<1", "p");
