...
void plotMake_YavgNcollR()
{
    ...
    TFile *input3 = new TFile("pAu200GeV_option3_YavgNcoll_remade.root", "read");
    ...
    TH1D *remade_ratio  = (TH1D*)input3 -> Get("YavgNcollR1");
	...
	TCanvas* c1 = new TCanvas("", "", 800, 600);
	{
		...
		remade_ratio -> SetMarkerStyle(28);
		remade_ratio -> SetMarkerColor(6);
		remade_ratio -> SetLineColor(6);
		remade_ratio -> Draw("p_same");			
