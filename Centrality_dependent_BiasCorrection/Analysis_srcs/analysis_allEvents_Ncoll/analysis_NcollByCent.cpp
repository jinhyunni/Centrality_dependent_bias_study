...
void analysis_NcollByCent()
{
    ...
    TString cent_input = TString::Format("%s/pAu200GeV_p8303ver2_option3_NcollCent_allEvents.root", prep_data.Data());
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver2_option3_NcollByCent.root", "recreate");
