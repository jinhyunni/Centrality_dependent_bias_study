void plotMake_correlations_withMidDirPhoton_ratioChargeEta_pTClass2MB()
{
    ...
    TCanvas *c1 = new TCanvas("", "", 800, 600);
    {
        ...
        ratio_2 -> SetMarkerColor(kTeal+1);
        ratio_2 -> SetLineColor(kTeal+1);
        ratio_2 -> Draw("p same");

        ratio_3 -> SetMarkerStyle(28);
        ratio_3 -> SetMarkerColor(kCyan+1);
        ratio_3 -> SetLineColor(kCyan+1);
        ratio_3 -> Draw("p same");
        ...
        ratio_5 -> SetMarkerColor(kBlue+1);
        ...
        leg1 -> AddEntry(ratio_1, "Events with 2 GeV #leq p_{T} < 4 GeV #gamma^{dir} at |#eta|<1", "p");
        leg1 -> AddEntry(ratio_2, "Events with 4 GeV #leq p_{T} < 7 GeV #gamma^{dir} at |#eta|<1", "p");
        leg1 -> AddEntry(ratio_3, "Events with 7 GeV #leq p_{T} < 10 GeV #gamma^{dir} at |#eta|<1", "p");
        leg1 -> AddEntry(ratio_4, "Events with 10 GeV #leq p_{T} < 15 GeV #gamma^{dir} at |#eta|<1", "p");
        //leg1 -> AddEntry(ratio_5, "Events with 15 GeV #leq p_{T} < 20 GeV #gamma^{dir} at |#eta|<1 / MB", "p");
