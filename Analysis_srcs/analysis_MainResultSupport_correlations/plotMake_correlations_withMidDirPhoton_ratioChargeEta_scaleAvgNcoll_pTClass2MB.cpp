void plotMake_correlations_withMidDirPhoton_ratioChargeEta_scaleAvgNcoll_pTClass2MB()
{
    TFile *input1 = new TFile("pAu200GeV_p8303_ver2_option3_correlations_ratioChargeEta_scaleAvgNcoll_pTClass2MB_withMidDirPhoton.root", "read");
    ...
    TCanvas *c1 = new TCanvas("", "", 800, 600);
    {
        ...
        ratio_6 -> SetMarkerColor(kBlue);
        ratio_6 -> SetLineColor(kBlue);
        ratio_6 -> Draw("p same");
        ...
        leg1 -> AddEntry(ratio_1, "Events with p_{T} #LT 2 GeV #gamma^{dir} at |#eta|<1", "p");
