...
void analysis_correlations_withDirPhoton_charge()
{
    //input
    //-----
    ...
    for(int i=0; i<5; i++)
    {
        TString inputname = Form("charge_corWithDirPhoton_pTClass%d", i+1);
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver2_option3_correlations_withDirPhoton_charge_bypTClass_byCentClass.root", "recreate");
