void plotMake_correlations_withMidDirPhoton_Nevent_pTClass2MB()
{
    TFile *input1 = new TFile("pAu200GeV_p8303_ver2_option3_correlations_NeventByCent_withDirPhoton_ofpTClass.root", "read");
    ...
    TCanvas *c1 = new TCanvas("", "", 800, 600);
    {
        ...
        ratio_4 -> SetMarkerColor(kBlue+1);
        ratio_4 -> SetLineColor(kBlue+1);
        //ratio_4 -> Draw("p same");
        ...
        leg1 -> AddEntry("", "Events with #gamma^{dir} at mid-rapdity, of pTClasses", "h");
