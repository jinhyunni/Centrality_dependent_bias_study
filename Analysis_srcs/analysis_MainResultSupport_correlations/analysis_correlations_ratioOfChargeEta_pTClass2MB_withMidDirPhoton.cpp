...
void analysis_correlations_ratioOfChargeEta_pTClass2MB_withMidDirPhoton()
{
	//input
	//-----
	...
	{
		TString inputName = Form("charge_eta_corWithDirPhoton_ofpTClass%d_scaled", pT+1);
		charge_corWithDirPhoton[pT] = (TH1D*)input -> Get(inputName);
	}
	...
	{	
		...
		charge_ratiopTMB[pT] = (TH1D*)charge_corWithDirPhoton[pT] -> Clone(outputname1);
