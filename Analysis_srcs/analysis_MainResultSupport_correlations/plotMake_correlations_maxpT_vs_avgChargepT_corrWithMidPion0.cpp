...
{
    TFile *input = new TFile("../pre_processed/pAu200GeV_p8303_ver5_option3_correlations_withPion0_TProfileNcollMaxpT.root", "read");
	
	TProfile *maxpT_vs_avgpT = (TProfile*)input -> Get("maxpT_vs_avgNcoll_corrWithMidPion0");
