...
root -l -b -q analysis_correlations_ratioOfChargeEta_scaleAvgNcoll_pTClass2MB_withMidPion0.cpp
...
root -l -b -q analysis_correlations_ratioOfChargeEta_scaleAvgNcoll_pTClass2MB_withMidDirPhoton.cpp
