void analysis_dNdetaPion0_byCent_inMidJetEvents()
{
    //input
    //-----
    ...
    {   
        ...
        pion0Byeta_midpion0[i][0] = (TH1D*)particle[i] -> ProjectionX(outputname1, 1, 2000, 1, 1);
        pion0Byeta_midpion0[i][1] = (TH1D*)particle[i] -> ProjectionX(outputname2, 1, 2000, 2, 2);
        pion0Byeta_midpion0[i][2] = (TH1D*)particle[i] -> ProjectionX(outputname3, 1, 2000, 3, 4);
        pion0Byeta_midpion0[i][3] = (TH1D*)particle[i] -> ProjectionX(outputname4, 1, 2000, 5, 6);
        pion0Byeta_midpion0[i][4] = (TH1D*)particle[i] -> ProjectionX(outputname5, 1, 2000, 7, 8);
    }
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver2_option3_dNdetaPion0_byCent_inMidJetEvents.root", "recreate");
    for(int i=0; i<5; i++)
    {       
        for(int j=0; j<5; j++)
        {
