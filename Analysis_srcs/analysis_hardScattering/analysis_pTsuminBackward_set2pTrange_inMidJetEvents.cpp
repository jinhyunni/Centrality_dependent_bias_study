...
{   
    //input
    //-----
    TFile *input = new TFile("../pre_processed/pAu200GeV_p8303ver4_option3_TH1DpTsumTriggerpT_set2pTrange_inMidJetEvents.root", "read");
    ...
    pTsum[4] = (TH1D*)input -> Get("pTsumTriggerpT_9to11GeV");
    ...
    //Output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver4_option3_pTsuminBackward_set2pTrange_inMidJetEvents.root", "recreate");
    for(int i=0; i<7; i++)
    {
