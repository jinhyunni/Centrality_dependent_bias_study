void plotMake_ratioCent2MB_scaledYield_highpT_pion0cent()
{
    TFile *input1 = new TFile("pAu200GeV_p8303ver5_onlyDirPhotonUsed_option3_pion0_ratio_scaled-dNdpT_highpT.root", "read");
    ...
    TCanvas *c1 = new TCanvas("", "", 800, 600);
    {
		...
		htmp -> GetYaxis() -> SetTitleOffset(1.29140625);
