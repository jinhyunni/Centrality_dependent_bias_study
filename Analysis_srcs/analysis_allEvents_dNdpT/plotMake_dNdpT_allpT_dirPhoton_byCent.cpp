...
{
    TFile *input1 = new TFile("pAu200GeV_p8303ver3_option3_dNdpT_allEvents.root", "read");
    TFile *input2 = new TFile("pAu200GeV_p8303ver3_option3_dNdpT_MBevents.root", "read");
