void analysis_dirPhoton_dNdpT_MBevents()
{
    //input
    //-----
    TFile *input1 = new TFile("../pre_processed/pAu200GeV_p8303_onlyDirPhoton_option3_TH2DpTeta_dirPhoton_midrapidity_MBevents.root", "read");
    TFile *input2 = new TFile("../pre_processed/pAu200GeV_p8303_onlyDirPhoton_option3_Ncoll_MBevents.root", "read");
    TFile *input3 = new TFile("../pre_processed/pAu200GeV_p8303_onlyDirPhoton_option3_avgNcoll_MBevents.root", "read");
