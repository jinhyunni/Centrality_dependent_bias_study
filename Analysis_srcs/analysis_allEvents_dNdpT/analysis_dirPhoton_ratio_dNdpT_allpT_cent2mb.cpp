void analysis_dirPhoton_ratio_dNdpT_allpT_cent2mb()
{
    //input
    //-----
    TFile *cent = new TFile("pAu200GeV_p8303ver3_option3_dirPhoton_dNdpT_allEvents.root", "read");
    TFile *mb = new TFile("pAu200GeV_p8303ver3_option3_dirPhoton_dNdpT_MBevents.root", "read");
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver3_option3_dirPhoton_ratio_scaled-dNdpT.root", "recreate");
