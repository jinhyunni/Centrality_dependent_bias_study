void analysis_pion0_ratio_dNdpT_allpT_cent2mb()
{
    //input
    //-----
    TFile *cent = new TFile("pAu200GeV_p8303ver3_option3_pion0_dNdpT_allEvents.root", "read");
    TFile *mb = new TFile("pAu200GeV_p8303ver3_option3_pion0_dNdpT_MBevents.root", "read");
