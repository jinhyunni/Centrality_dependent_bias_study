void analysis_dirPhoton_ratio_dNdpT_highpT_cent2mb()
{
    //input
    //-----
    TFile *cent = new TFile("pAu200GeV_p8303_onlyDirPhoton_option3_dirPhoton_dNdpT_allEvents.root", "read");
    TFile *mb = new TFile("pAu200GeV_p8303_onlyDirPhoton_option3_dirPhoton_dNdpT_MBevents.root", "read");
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303_onlyDirPhoton_option3_dirPhoton_ratio_scaled-dNdpT_highpT.root", "recreate");
