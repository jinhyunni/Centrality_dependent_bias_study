void analysis_highpT_dNdetaCharge_byCent_allEvents()
{   
    //input
    //-----
    ...
    //get particle above 3 GeV
    // -> See the charged paticles from hard-scattering
    h1etaCharge[0] = (TH1D*)pTetaCharge -> ProjectionX("h1etaCharge_cent1", 301, 2000, 1, 1);
    h1etaCharge[1] = (TH1D*)pTetaCharge -> ProjectionX("h1etaCharge_cent2", 301, 2000, 2, 2);
    h1etaCharge[2] = (TH1D*)pTetaCharge -> ProjectionX("h1etaCharge_cent3", 301, 2000, 3, 4);
    h1etaCharge[3] = (TH1D*)pTetaCharge -> ProjectionX("h1etaCharge_cent4", 301, 2000, 5, 6);
    h1etaCharge[4] = (TH1D*)pTetaCharge -> ProjectionX("h1etaCharge_cent5", 301, 2000, 7, 8);
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver2_option3_highpT_dNdetaCharge_byCent_allEvents.root", "recreate");
