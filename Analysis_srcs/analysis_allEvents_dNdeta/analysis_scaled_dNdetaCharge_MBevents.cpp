void analysis_scaled_dNdetaCharge_MBevents()
{   
    //input
    //-----
    TFile *input_particle = new TFile("pAu200GeV_p8303ver2_option3_dNdetaCharge_MBevents.root", "read");
    TFile *input_ncoll = new TFile("../pre_processed/pAu200GeV_p8303ver4_option3_avgNcoll_MBevents.root", "read");

    TH1D *pTetaCharge = (TH1D*)input_particle -> Get("dndeta_mbevents");
    ...
    //output
    //------
    TFile *output = new TFile("pAu200GeV_p8303ver2_option3_scaled_dNdetaCharge_MBevents.root", "recreate");
