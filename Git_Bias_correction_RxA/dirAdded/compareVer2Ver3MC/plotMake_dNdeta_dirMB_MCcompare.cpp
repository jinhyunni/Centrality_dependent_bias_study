void plotMake_dNdeta_dirMB_MCcompare()
{
 ...
 //    TH1D *dir_ver3_inNPL = (TH1D*)input1 -> Get("h1eta_dir_ver3_inNPL");
    ...
    TH1D *dir_ver3_p8303ver3 = (TH1D*)input1 -> Get("h1eta_dir_ver3_p8303ver3");
 ...
 //        dir_ver3_inNPL -> Draw("p same");
        ...
        dir_ver3_p8303ver3 -> SetMarkerStyle(30);
        dir_ver3_p8303ver3 -> SetMarkerColor(kTeal+3);
        dir_ver3_p8303ver3 -> SetLineColor(kTeal+3);
        dir_ver3_p8303ver3 -> Draw("p same");
