void plotMake_ratio_dNdeta_pion0MB_MCcompare()
{
	TFile *input1 = new TFile("pAu200GeV_option3_ratio_dNdeta_MCcompare.root", "read");
  
    //dndeta in MB events
    
    TH1D *ver2npl_8303_externalOn = (TH1D*)input1 -> Get("pion0_ratio_ver2npl_8303_externalOn");
    TH1D *ver3kiaf_8307_externalOff = (TH1D*)input1 -> Get("pion0_ratio_ver3kiaf_8307_externalOff");
    TH1D *ver3npl_8303_externalOff = (TH1D*)input1 -> Get("pion0_ratio_ver3npl_8303_externalOff");
    TH1D *ver3kiaf_8303_externalOff = (TH1D*)input1 -> Get("pion0_ratio_ver3kiaf_8303_externalOff");
	...
	//	TH1D *htmp = (TH1D*)gPad -> DrawFrame(-1.5, 2.6, 1.5, 5);
		...
		htmp -> GetYaxis() -> SetTitle("(#frac{1}{N_{event}} #frac{dN^{#pi^{0}}}{d#eta})_{target MC} / (#frac{1}{N_{event}} #frac{dN^{#pi^{0}}}{d#eta})_{reference MC}");
