void plotMake_dNdetaDirphoton_inTargetEvents_compareMC()
{
 ...
 //        leg1 -> AddEntry(old_dndeta_dir_inpion0, "#gamma^{dir}, #pi^{0} in mid-rapidity, Old-MC sets", "p");
        leg1 -> AddEntry(new_dndeta_dir_indir, "#gamma^{dir}, #gamma^{dir} in mid-rapidity, New-MC sets", "p");
        leg1 -> AddEntry(old_dndeta_dir_indir, "#gamma^{dir}, #gamma^{dir} in mid-rapidity, Old-MC sets", "p");
