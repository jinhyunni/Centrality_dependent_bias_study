...
void plotMake_pTpion_rebined()
{
	//Read in TFile
	TFile* input = new TFile("pAu200GeV_option3_pion0Analysis_etacut_INEL_1e5_rebined.root", "read");
	...
	TFile* output = new TFile("pAu200GeV_option3_pTpion_invarY1e5_rebined.root", "recreate");
